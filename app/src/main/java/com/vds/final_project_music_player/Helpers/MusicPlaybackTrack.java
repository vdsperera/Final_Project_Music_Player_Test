...
public class MusicPlaybackTrack implements Parcelable {
    ...
    public CupicUtils.IdType mSourceType;
    public int mSourcePosition;

    public MusicPlaybackTrack(long id, long sourceId, CupicUtils.IdType type, int sourcePosition) {
        mId = id;
        mSourceId = sourceId;
        mSourceType = type;
    ...
    public MusicPlaybackTrack(Parcel in) {
        ...
        mSourceType = CupicUtils.IdType.getTypeById(in.readInt());
